...
{
	UniformBuffer::UniformBuffer(const VkDevice* logicalDevice, const VkPhysicalDevice* physicalDevice, const VkSurfaceKHR* surface, const VkCommandPool* commandPool, const VkQueue* queue)
	{
	...
	void UniformBuffer::Update(const VkDevice* logicalDevice, const VkExtent2D &swapChainExtent)
	{
		...
		//ubo.view = glm::lookAt(glm::vec3(1.0f*time, 1.0f*time, 1.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.0f, 0.0f));
